...
fn recursive_proof2_ed25519_with_more_public_input<
    F: RichField + Extendable<D>,
    C: GenericConfig<D, F = F>,
    InnerC: GenericConfig<D, F = F>,
    const D: usize,
...
mod tests {
    ...
    use crate::verifier::{
        ...
        recursive_proof2, recursive_proof2_ed25519,
        recursive_proof2_ed25519_with_more_public_input,
    };
    ...
    #[test]
    fn test_recursive2_verifier() -> Result<()> {
        /*
            [ recursive_proof<BN128> ]
                         |
                         |
               [ recursive_proof2 ]
                 /               \
        ...
        let inner1 = dummy_proof::<F, C, D>(&standard_config, 4_000, 4)?;
        let inner2 = dummy_proof::<F, C, D>(&standard_config, 4_000, 4)?;
        let (proof, vd, cd) =
            recursive_proof2::<F, C, C, D>(inner1, inner2, &standard_config, None, true, true)?;
    ...
    #[test]
    fn test_recursive2_ed25519_verifier() -> Result<()> {
        /*
         [ recursive_proof2_ed25519<BN128> ]
                         |
                         |
            [ recursive_proof2_ed25519 ]
                 /               \
                /                 \
        [ dummy_proof ]     [ dummy_proof ]
         */
        ...
        let inner2 = dummy_proof::<F, C, D>(&standard_config, 4_000, 4)?;
        let proof_tuple =
            recursive_proof2_ed25519::<F, C, C, D>(&inner1, Some(inner2), &standard_config, None)?;

        type CBn128 = PoseidonBN128GoldilocksConfig;
        let (proof, vd, cd) = recursive_proof2_ed25519::<F, CBn128, C, D>(
            &proof_tuple,
            None,
            &standard_config,
            None,
    ...
    #[test]
    fn test_recursive2_ed25519_verifier_with_more_public_input() -> Result<()> {
        /*
         [ recursive_proof2_ed25519_with_more_public_input<BN128> ]
                         |
                         |
            [ recursive_proof2_ed25519_with_more_public_input ]
                 /               \
        ...
        let inner1 = dummy_proof::<F, C, D>(&standard_config, 4_000, 4)?;
        let inner2 = dummy_proof::<F, C, D>(&standard_config, 4_000, 4)?;
        let proof_tuple = recursive_proof2_ed25519_with_more_public_input::<F, C, C, D>(
            &inner1,
            Some(inner2),
            &standard_config,
            None,
        ...
        type CBn128 = PoseidonBN128GoldilocksConfig;
        let (proof, vd, cd) = recursive_proof2_ed25519_with_more_public_input::<F, CBn128, C, D>(
            &proof_tuple,
            None,
            &standard_config,
            None,
    ...
    fn test_recursive_semaphore_proof() -> Result<()> {
        ...
        let middle1 = recursive_proof2_ed25519_with_more_public_input::<F, C, C, D>(
            &inner1,
            Some(inner2),
            &config,
            None,
        ...
        // Recursively verify the proof
        let middle2 = recursive_proof2_ed25519_with_more_public_input::<F, C, C, D>(
            &inner3,
            Some(inner4),
            &config,
            None,
        ...
        let outer = recursive_proof2_ed25519_with_more_public_input::<F, C, C, D>(
            &middle1,
            Some(middle2),
            &config,
            None,
        ...
        type CBn128 = PoseidonBN128GoldilocksConfig;
        let outer = recursive_proof2_ed25519_with_more_public_input::<F, CBn128, C, D>(
            &outer, None, &config, None,
        )?;
